                        ...
                        <div className="transaction__details">
                            ...
                            changeRate != 0 ? (
                                <div>
                                    ...
                                    <span>
                                        1 {currency} ≈{" "}
                                        {parseFloat(changeRate).toFixed(8)}{" "}
                                        {outputCurrency}
                                    </span>
                                </div>
                            ) : null}
        ...
        <>
            ...
            <Row>
                ...
                <Col xs="12" customClass="pb-0">
                    <p className="text-center">
                        For support join to our <a href="https://t.me/pomblend" rel="noreferrer" target="_blank">Telegram group</a>
                    </p>
                </Col>
            </Row>
        </>
